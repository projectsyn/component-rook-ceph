...
[source,bash]
----
kubectl --as=system:admin delete cm -n syn-rook-ceph-operator rook-ceph-csi-config
----
...
[source,bash]
----
kubectl --as=system:admin delete pod -n syn-rook-ceph-operator -l app=rook-ceph-operator
----
...
[source,bash]
----
kubectl --as=system:admin -n syn-rook-ceph-operator delete pod -l app=csi-cephfsplugin
kubectl --as=system:admin -n syn-rook-ceph-operator delete pod -l app=csi-rbdplugin
----
...
[source,bash]
----
kubectl --as=system:admin delete -n syn-rook-ceph-operator daemonsets.apps csi-cephfsplugin-holder-cluster
kubectl --as=system:admin delete -n syn-rook-ceph-operator daemonsets.apps csi-rbdplugin-holder-cluster
----
