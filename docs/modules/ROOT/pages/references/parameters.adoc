...
=== Enable machine disruption budgets on OpenShift 4

The component automatically configures some things for OpenShift 4.
However, users need to explicitly enable machine disruption budgets.
...
----
<1> Tell the operator to create and manage MachineDisruptionBudgets.
