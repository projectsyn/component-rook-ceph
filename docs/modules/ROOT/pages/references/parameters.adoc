...
Control placement of osd pods, empty by default.

See https://github.com/rook/rook/blob/master/Documentation/ceph-cluster-crd.md#storage-class-device-sets[Storage Class Device Sets] for a more detailed explanation.
